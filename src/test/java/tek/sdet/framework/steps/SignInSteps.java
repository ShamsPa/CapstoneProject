...
public class SignInSteps extends CommonUtility {
	...
	@When("User click on Create New Account button")public void userClickOnCreateNewAccountButton() {
	...
	public void userFillTheSignUpInformationWithBelowData(DataTable dataTable) {
		...
		sendText(factory.signInPage().createNewAccountButton,data.get(0).get("name"));
	...
	public void userClickOnSignUpButton() {click(factory.signInPage().signUpButton);
